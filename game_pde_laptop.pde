...
float drum_w = 250/2;
float drum_h = 100/2;
float base_speed = 17/2;
float note_speed = base_speed;
float min_speed = 17/2;
float max_speed = 25/2;
int current_combo = 0;
int longest_combo = 0;

// Note Positions
float OVER_DRUM_0 = 75/2;
float OVER_DRUM_1 = 375/2;
float OVER_DRUM_2 = 675/2;
float OVER_DRUM_3 = 1025/2;
float OVER_DRUM_4 = 1325/2;
float OVER_DRUM_5 = 1625/2;
...
void setup() {
	...
	notes[0] = new Note(OVER_DRUM_3,0,200/2,70/2,255,255,255, true);
	notes[1] = new Note(OVER_DRUM_0,0,200/2,70/2,255,255,255, false);
...
// Set up Drums
Drum d0 = new Drum(50/2,850/2,drum_w,drum_h);
Drum d1 = new Drum(350/2,850/2,drum_w,drum_h);
Drum d2 = new Drum(650/2,850/2,drum_w,drum_h);
Drum d3 = new Drum(1000/2,850/2,drum_w,drum_h);
Drum d4 = new Drum(1300/2,850/2,drum_w,drum_h);
Drum d5 = new Drum(1600/2,850/2,drum_w,drum_h);
...
Drumstick ds1 = new DrumStick(1900/2,0,255);
...
void draw_score() {
	...
	text("Score: " + score, 60/2, 60/2);
}

void draw_speed() {
	textSize(50/2);
	fill(text_r,text_g,text_b);
	text("Level: " + (note_speed-7.5), 60/2, 120/2);
}

void draw_lives() {
	textSize(50/2);
	fill(text_r,text_g,text_b);
	text("Lives: " + lives, 1600/2, 60/2);
}

void draw_combo() {
	textSize(50/2);
	fill(text_r,text_g,text_b);
	text("Combo: " + current_combo, 1600/2, 120/2);
}
